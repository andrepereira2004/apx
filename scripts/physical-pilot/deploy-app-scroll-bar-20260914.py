...
def main():
    ...
    rels=['quickshell/apx/BarButton.qml','hypr/hyprland.lua','quickshell/apx/shell.qml']
    ...
    backup=Path('/var/lib/apx/backups')/(datetime.datetime.now(datetime.timezone.utc).strftime('%Y%m%dT%H%M%SZ')+'-app-scroll-bar');backup.mkdir(mode=0o700)
    manifest=[]
