...
readonly backup=/var/lib/apx/backups/20260824-vm-executable-readiness-v10

fail() { printf 'APX VM readiness deployment refused: %s\n' "$1" >&2; exit 2; }
...
/usr/bin/printf 'APX VM executable-readiness correction installed; rollback: %s\n' "$backup"
