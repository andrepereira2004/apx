...
readonly backup=/var/lib/apx/backups/20260824-vm-launcher-owned-liveness-v13

fail() { printf 'APX VM liveness deployment refused: %s\n' "$1" >&2; exit 2; }
...
/usr/bin/printf 'APX launcher-owned VM liveness installed; rollback: %s\n' "$backup"
