...
echo APX: depois desse inicio, prima SUPER+SHIFT+N para entrar no modo RTX nativo.
echo APX: SUPER+SHIFT+R volta sempre ao ecra direto de recuperacao.
echo APX: SUPER+E regressa ao HUB sem desligar fisicamente.
echo.
choice /C RN /N /M "Prima R para reiniciar agora ou N para reiniciar mais tarde: "
if errorlevel 2 exit /b 0
shutdown.exe /r /t 5 /c "APX: a reiniciar para concluir a aceleracao nativa"
exit /b 0
