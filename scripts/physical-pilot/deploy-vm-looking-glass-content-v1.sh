...
readonly backup=/var/lib/apx/backups/20260824-vm-looking-glass-content-v12

fail() { printf 'APX Looking Glass content deployment refused: %s\n' "$1" >&2; exit 2; }
...
/usr/bin/printf 'APX Looking Glass content correction installed; rollback: %s\n' "$backup"
